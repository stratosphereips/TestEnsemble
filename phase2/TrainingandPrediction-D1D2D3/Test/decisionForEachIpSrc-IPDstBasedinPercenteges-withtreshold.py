...
dir=os.mkdir('resultCounter'+str(countTCPE)+'-Percentege'+str(TCPEP))
os.chdir('resultCounter'+str(countTCPE)+'-Percentege'+str(TCPEP))
datasetout="result"+str(countTCPE)+str(TCPEP)+".csv"
...
dConfusion ['Percentege:'+str(TCPEP)+'-Counter:'+str(countTCPE)]={'ThresholdPercentegeMaliciousFlowsPerIPDst': TCPEP, 'ThresholdCounterMaliciousFlowsPerIPDst': countTCPE,'FP': FP, 'FN': FN, 'TP': TP, 'TN': TN, 'FalsePositiveRate': FPR, 'TruePositiveRate': TPR, 'F1Score': F1Score, 'Accuracy': Accuracy}
