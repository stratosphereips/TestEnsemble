...
#no se usa un clasificador base (como en Adaboost)
model1 = GradientBoostingClassifier(n_estimators=100, learning_rate=0.1)
result1 = model_selection.cross_val_score(model1, X_test_mixed_std, y_test_mixed, cv=5)
print("Accuracy: %0.10f (+/- %0.10f) [%s]" % (result1.mean(), result1.std(), 'GradientBoostingClassifier Train'))
