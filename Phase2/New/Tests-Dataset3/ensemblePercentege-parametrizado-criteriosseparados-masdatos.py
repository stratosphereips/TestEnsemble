...
def build_dataset_with_infected_labels(datasetin,TCPEP,countTCPE,TCPNEP,countTCPNE,UDPEP,countUDPE,UDPNEP,countUDPNE):
   #datasetin es el nombre del archivo de entrada
   df= process_file(datasetin)
...
datasetin='2018-05-03_win11.binetflow'
...
for counter in [0,1,5,10,25,50]:
   ...
   for percentege in [1,2,3,4,5]:
      ...
      countUDPE=counter
      countUDPNE=counter
      df_new=build_dataset_with_infected_labels(datasetin,TCPEP,countTCPE,TCPNEP,countTCPNE,UDPEP,countUDPE,UDPNEP,countUDPNE)
